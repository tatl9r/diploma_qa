...
public class OrderPage {
    ...
    private final SelenideElement cardHolderName = $x("//*[.='Владелец'] //input");
    ...
    private final SelenideElement cardHolderFieldError = $x("//span[contains(text(),'Владелец')]").parent().$(".input__sub");
    private final SelenideElement cvcFieldError = $x("//span[contains(text(),'CVC/CVV')]").parent().$(".input__sub");


    public void completePayFrom(String number, String month, String year, String cardHolder, String cvc) {
